---
title: "Agent"
description: "AGENT.md — notas del agente"
---
...
| Executors | Classifier, Interrupt, TODO List, WorkflowRouter | + RandomTalk, Podcast (P2) |
...
| Connectors | Calendar, CLI | + Discord, OpenProject (P2) |
...
├── plugins/
│   ├── audio-input.md       # Mic, Meet, silero VAD
│   ├── audio-processor.md   # Whisper transcription
│   ├── audio-output.md      # Zonos, EdgeTTS, Camb TTS
│   ├── executors.md         # Classifier, Interrupt, TODO, WorkflowRouter
│   ├── connectors.md        # Calendar, CLI
│   └── system.md            # TUI, MCP Server, HTTP Server, VoiceManager
├── voices/
│   ├── overview.md          # Factory-based voice discovery
