...
| 107 | El flush de turno dispara mientras el usuario habla | Alta | `kateto/plugins/audio_input/listener.py` | [107-flush-de-turno-dispara-mientras-el-usuario-habla.md](./bugs/107-flush-de-turno-dispara-mientras-el-usuario-habla.md) |
| 108 | Turnos encolados no se descartan tras un barge-in del usuario | Alta | `kateto/plugins/system/turn_gate.py` | [108-turnos-encolados-no-se-descartan-tras-barge-in.md](./bugs/108-turnos-encolados-no-se-descartan-tras-barge-in.md) |
