...
## 1. Data Plane / Control Plane Split (resuelve lentitud de streams)
...
## 2. VoiceManager — enrutamiento entre clasificador y voces
...
## 3. Interjección Consciente (pisarse la charla a propósito)
...
### 4b. Framework de Tools / Skills / MCP  ✅ DECIDIDO: pydantic-ai + FastMCP
...
### 4i. Workflows — result_type + deshabilitar clasificador placeholder
...
- Nota: estos 3 son responsabilidad de otro agente/otra fase, no de la refactor
  de SPEC_2.

### 4d. Traza Única (mejora de debuggabilidad)
...
### 4e. Auditoría de Sobre-ingeniería — Ponytail-audit (OBLIGATORIO, 1 SOLA VEZ AL PRINCIPIO)
...
### 4g. Flujo de auditoría (Ponytail)
1. Tras cada cambio en `kateto/`, correr `ponytail-audit`.
